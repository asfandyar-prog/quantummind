...
export default function LandingPage() {
  ...
  const t = dark ? {
    ...
    cardBorderH: 'rgba(255,255,255,0.15)',
    sectionBg:   'rgba(255,255,255,0.03)',
    sectionBord: 'rgba(255,255,255,0.07)',
    divider:     'rgba(255,255,255,0.07)',
    btnSecBg:    'rgba(255,255,255,0.05)',
    btnSecBord:  'rgba(255,255,255,0.12)',
    ...
    cardBorderH: 'rgba(0,0,0,0.14)',
    sectionBg:   '#FFFFFF',
    sectionBord: 'rgba(0,0,0,0.07)',
    divider:     'rgba(0,0,0,0.08)',
    btnSecBg:    '#FFFFFF',
    btnSecBord:  'rgba(0,0,0,0.12)',
    btnSecHov:   '#F5F5F7',
    ctaBg:       '#1C1C1E',
    ctaColor:    '#FFFFFF',
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: '18px', fontWeight: 700, letterSpacing: '-0.3px', background: 'linear-gradient(135deg, #007AFF, #5856D6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
          QuantumMind
        </span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <button
            onClick={toggleTheme}
            style={{ fontSize: '14px', color: t.textMuted, background: 'transparent', border: 'none', cursor: 'pointer', fontFamily: FONT, padding: '6px 10px', borderRadius: '8px', transition: 'color 0.15s' }}
          ...
          <button
            ...
            style={{ fontSize: '13px', fontWeight: 500, color: t.textMuted, background: 'transparent', border: 'none', cursor: 'pointer', fontFamily: FONT, padding: '6px 14px', borderRadius: '8px', transition: 'color 0.15s' }}
            onMouseEnter={e => e.target.style.color = t.text}
            onMouseLeave={e => e.target.style.color = t.textMuted}
          >
            Tutor Login
          ...
          <motion.button
            ...
            style={{ fontSize: '13px', fontWeight: 600, color: t.navBtnColor, background: t.navBtn, border: 'none', cursor: 'pointer', fontFamily: FONT, padding: '7px 18px', borderRadius: '20px' }}
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '52px 40px 0', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <motion.p
          style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#007AFF', marginBottom: '20px' }}
        ...
        <motion.h1
          style={{ fontSize: 'clamp(44px, 6vw, 76px)', fontWeight: 800, letterSpacing: '-2.5px', lineHeight: 1.05, marginBottom: '24px', maxWidth: '900px' }}
        ...
        <motion.p
          style={{ fontSize: '18px', color: t.textSecond, lineHeight: 1.6, maxWidth: '520px', marginBottom: '40px' }}
        ...
        {/* Stats */}
        <motion.div
          style={{ display: 'flex', gap: '48px', justifyContent: 'center', marginBottom: '48px', flexWrap: 'wrap' }}
        ...
        {/* Divider */}
        <motion.div
          style={{ width: '1px', height: '40px', background: `linear-gradient(to bottom, ${t.divider}, transparent)`, marginBottom: '40px' }}
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <motion.button
              onClick={() => navigate('/select')}
              style={{ padding: '14px 32px', borderRadius: '12px', border: 'none', background: '#007AFF', color: '#FFFFFF', fontSize: '15px', fontWeight: 600, fontFamily: FONT, cursor: 'pointer', boxShadow: '0 0 32px rgba(0,122,255,0.4)' }}
              whileHover={{ scale: 1.04, boxShadow: '0 0 48px rgba(0,122,255,0.5)' }}
              whileTap={{ scale: 0.97 }}
            >
              Start Learning Free →
            </motion.button>
            <motion.button
              ...
              style={{ padding: '14px 28px', borderRadius: '12px', border: `1px solid ${t.btnSecBord}`, background: t.btnSecBg, color: t.text, fontSize: '15px', fontWeight: 600, fontFamily: FONT, cursor: 'pointer' }}
              whileHover={{ background: t.btnSecHov }}
              whileTap={{ scale: 0.97 }}
            >
              Explore Features ↓
            </motion.button>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{ fontSize: '17px', color: t.textMuted, maxWidth: '480px', margin: '0 auto' }}>
              Each mode is powered by a dedicated LangGraph AI agent — built for the way you actually learn.
            </p>
          </motion.div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '16px' }}>
            {FEATURES.slice(0, 3).map((f, i) => (
              ...
              >
                ...
                {hovered === i && <motion.div style={{ height: '2px', background: f.color, borderRadius: '1px', marginTop: '20px' }} initial={{ width: '0%' }} animate={{ width: '100%' }} transition={{ duration: 0.3 }} />}
              </motion.div>
            ))}
          </div>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
            {FEATURES.slice(3).map((f, i) => (
              <motion.div
                key={f.title}
                style={{
                  background: hovered === i ? t.cardBgHover : t.cardBg,
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                  ...
                  <span style={{
                    ...
                    background: f.tag === 'Free' ? 'rgba(52,199,89,0.12)' : f.tag === 'Premium' ? 'rgba(255,149,0,0.12)' : dark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)',
              ...
              <motion.div key={f.title}
                style={{ width: 'calc(33.33% - 8px)', background: hovered === i + 3 ? t.cardBgH : t.cardBg, border: `1px solid ${hovered === i + 3 ? t.cardBorderH : t.cardBorder}`, borderRadius: '20px', padding: '32px', cursor: 'default', transition: 'all 0.2s', boxShadow: hovered === i + 3 ? `0 8px 32px ${f.color}12` : 'none' }}
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 + 0.24, duration: 0.5 }}
                onMouseEnter={() => setHovered(i + 3)} onMouseLeave={() => setHovered(null)}
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                  <div style={{ width: '44px', height: '44px', borderRadius: '12px', background: `${f.color}18`, border: `1px solid ${f.color}28`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>{f.icon}</div>
                  <span style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: f.tag === 'Free' ? '#34C759' : f.tag === 'Premium' ? '#FF9500' : t.textMuted, background: f.tag === 'Free' ? 'rgba(52,199,89,0.12)' : f.tag === 'Premium' ? 'rgba(255,149,0,0.12)' : t.tagSoon, padding: '3px 10px', borderRadius: '20px' }}>{f.tag}</span>
                ...
                <h3 style={{ fontSize: '20px', fontWeight: 700, color: t.text, marginBottom: '10px', letterSpacing: '-0.3px' }}>{f.title}</h3>
                <p style={{ fontSize: '14px', color: t.textMuted, lineHeight: 1.65 }}>{f.description}</p>
                {hovered === i + 3 && <motion.div style={{ height: '2px', background: f.color, borderRadius: '1px', marginTop: '20px' }} initial={{ width: '0%' }} animate={{ width: '100%' }} transition={{ duration: 0.3 }} />}
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '0 48px 120px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', background: t.sectionBg, border: `1px solid ${t.sectionBord}`, borderRadius: '24px', padding: '56px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '56px', alignItems: 'center' }}>
            <div>
              <h2 style={{ fontSize: '36px', fontWeight: 800, letterSpacing: '-1px', color: t.text, marginBottom: '16px' }}>
                Built like a research lab.<br />Deployed at zero cost.
              </h2>
              <p style={{ fontSize: '16px', color: t.textMuted, lineHeight: 1.7 }}>
                Every component mirrors production AI systems at Google DeepMind, IBM Research, and ETH Zurich's Agentic Systems Lab.
              </p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {[
                ...
                <motion.div key={i} style={{ display: 'flex', alignItems: 'center', gap: '14px' }}
      ...
      <section style={{ padding: '0 48px 120px', textAlign: 'center' }}>
        ...
        >
          <h2 style={{ fontSize: '48px', fontWeight: 800, letterSpacing: '-1.5px', color: t.text, marginBottom: '16px', lineHeight: 1.1 }}>
            Start learning<br />quantum computing today.
          </h2>
          <p style={{ fontSize: '17px', color: t.textMuted, marginBottom: '36px', lineHeight: 1.6 }}>
            Theory, Practice, and Guided modes are free forever.
          </p>
          <motion.button
            onClick={() => navigate('/select')}
            style={{ padding: '16px 44px', borderRadius: '14px', border: 'none', background: t.ctaBg, color: t.ctaColor, fontSize: '17px', fontWeight: 700, fontFamily: FONT, cursor: 'pointer' }}
      ...
      <footer style={{ padding: '24px 48px', borderTop: `1px solid ${t.divider}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          {[
            { label: 'GitHub', href: 'https://github.com/asfandyar-prog/quantummind' },
            { label: 'LinkedIn', href: 'https://linkedin.com/in/asfand-yar-3966b8291' },
          ].map(link => (
            <a key={link.label} href={link.href} target="_blank" rel="noreferrer"
              style={{ fontSize: '13px', color: t.textMuted, textDecoration: 'none', fontWeight: 500, transition: 'color 0.15s' }}
